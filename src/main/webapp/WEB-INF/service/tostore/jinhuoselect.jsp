...
<html>
  ...
  <c:if test="${empty sessionScope.login }">
   ...
   <div class="container-fluid">
		...
		<c:if test="${forselect.size()==0}">
			<div class="row">
				<div class="page-header">
					<h3 class="text-center">没有查询到符合条件的药品信息！<a href="<%=basePath%>tostore">返回</a></h3>
			...
			<div class="row">
				<div class="col-md-12">
					<table class="table table-hover table-condensed table-bordered">
						...
						<c:forEach items="${forselect }" var="ds">
							<tr>
								<td>${ds.drugname }</td>
								<td>${ds.changshang }</td>
								<td>${ds.beizhu }</td>
	...
	<form id="ff" action="<%=basePath%>toaddjinhuo" method="POST">
