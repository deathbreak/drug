		...
		<c:if test="${not empty druginfo }">
			...
			<form action="<%=basePath%>addjinhuo" method="post">	
				<table class="table">
    					<tr>
    						<td>药品信息:</td>
    						<td><input type="text" class="form-control" name="drugname" value="${druginfo.drugname }" readonly></td>
    						<td>单位:</td>
    						<td><input type="text" class="form-control" name="unit" value="${druginfo.unit }" readonly></td>
    						<td>规格:</td>
    						<td><input type="text" class="form-control" name="guige" value="${druginfo.guige }" readonly></td>
    					</tr>
    					<tr>
    					    <td>生产厂商:</td>
    					...
    					<tr>
    						<td>药品位置:</td>
    						<td><input type="text" class="form-control" name="location" value="${druginfo.location }" readonly></td>
    						<td>批号:</td>
    					...
    					<tr>
    						...
    						<td></td>
    						<td><button type="submit" class="btn btn-primary btn-block" id="btn-submit">添加至入库列表</button></td>
    					</tr>
  				</table>
  			</form>
			</div>
