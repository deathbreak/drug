                ...
                <nav aria-label="Page navigation">
                    <ul class="pagination">
                        ...
                        <c:if test="${queryresult.hasPreviousPage }">
                            <li>
                                <a href="<%=basePath%>querystore?pn=${queryresult.pageNum - 1}&querystore=${querystring }"
                        ...
                        <c:forEach items="${queryresult.navigatepageNums }" var="page_Num">
                            ...
                            <c:if test="${page_Num != queryresult.pageNum}">
                                <li>
                                    <a href="<%=basePath%>querystore?pn=${page_Num }&querystore=${querystring }">${page_Num }</a>
                                </li>
                            </c:if>
                        </c:forEach>
                        ...
                        <li>
                            <a href="<%=basePath%>querystore?pn=${queryresult.pages}&querystore=${querystring }">末页</a>
                        </li>
                        <!--  -->
                        <li>
                            <div class="btn-group dropup">
                                ...
                                <ul class="dropdown-menu">
                                    <c:forEach var="x" begin="1" end="${queryresult.pages}"
                                               step="10">
                                        <li><a
                                                href="<%=basePath%>querystore?pn=${x}&querystore=${querystring }">跳转至第${x }页</a>
                                        </li>
                                    </c:forEach>
                                </ul>
                            </div>
