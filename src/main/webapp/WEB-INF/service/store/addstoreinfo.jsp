		...
		<c:if test="${not empty drugstoreinfo }">
			...
			<form action="<%=basePath%>addtostore" method="post">	
				<table class="table">
    					<tr>
    						<td>药品信息:</td>
    						<td><input type="text" class="form-control" name="drugname" value="${drugstoreinfo.drugname }" readonly></td>
    						<td>单位:</td>
    						<td><input type="text" class="form-control" name="unit" value="${drugstoreinfo.unit }" readonly></td>
    						<td>规格:</td>
    						<td><input type="text" class="form-control" name="guige" value="${drugstoreinfo.guige }" readonly></td>
    					</tr>
    					<tr>
    					    <td>生产厂商:</td>
    					...
    					<tr>
    						<td>备注:</td>
    						<td><input type="text" class="form-control" name="beizhu" value="${drugstoreinfo.beizhu }" readonly></td>
    						<td>进价:</td>
    					...
    					<tr>
    						<td>药品位置:</td>
    						<td><input type="text" class="form-control" name="location" value="${drugstoreinfo.location }" readonly></td>
    						<td>批号:</td>
    					...
    					<tr>
    						<td>条形码:</td>
    						<td><input type="text" class="form-control" name="tiaoxingma" value="${drugstoreinfo.tiaoxingma }" readonly></td>
    						<td></td>
    						<td><span id="tips" style="color:red"></span></td>
    						<td></td>
    						<td><button type="submit" class="btn btn-primary btn-block" id="btn-submit">添加到库存</button></td>
    					</tr>
  				</table>
  			</form>
			</div>
