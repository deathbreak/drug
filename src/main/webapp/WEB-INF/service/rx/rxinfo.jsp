...
<div class="container-fluid">
    ...
    <div class="row" style="padding-top:3px">
        <ul class="nav nav-tabs nav-justified">
            <li role="presentation"><a href="<%=basePath%>rx">未填写的处方药信息</a></li>
            <li role="presentation" class="active"><a href="<%=basePath%>rxinfo">查看全部处方药登记记录</a></li>
        </ul>
    </div>

    <div class="row" style="padding-top:3px">
        <div class="col-md-3">
            <form action="<%=basePath%>queryrx" method="post">
            ...
            <c:forEach items="${rxallinfo }" var="it">
                <div class="panel panel-success">
                    ...
                    <table class="table table-hover table-condensed table-bordered">
                        ...
                        <tr>
                            <td colspan="6">
                                <button type="button" class="btn btn-info btn-abcd" data-toggle="modal"
                                        data-target="#myModal" data-sss="${it.rxperson[0].time }">修改处方药登记记录
                                </button>
                                <button type="button" class="btn btn-danger btn-acg" data-toggle="modal"
                                        data-target="#myModal2" data-delit="${it.rxperson[0].time }">删除
                                </button>
                            </td>
                        </tr>
                    </table>
    ...
    <div class="modal-dialog modal-lg" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form action="<%=basePath%>updaterxp" method="post">
                    <input type="hidden" id="input-time" name="time" value="">
                    <table class="table table-hover table-condensed table-bordered">
                        <tr>
                            <td>*顾客姓名:</td>
                            <td colspan="2"><input type="text" class="form-control" id="input-name" name="name"
                                                   value=""></td>
                            <td>性别:</td>
                            <td colspan="2">
                                <label class="radio-inline"><input type="radio" name="gendar" value="男"
                                                                   checked>男</label>
                        ...
                        <tr>
                            <td>年龄:</td>
                            <td colspan="2"><input type="number" class="form-control" id="input-age" name="age"
                                                   value=""></td>
                            <td>*聊系方式:</td>
                            <td colspan="2"><input type="text" class="form-control" id="input-phone" name="phone"
                                                   value=""></td>
                        </tr>
                        <tr>
                            <td>*地址:</td>
                            <td colspan="2"><input type="text" class="form-control" id="input-loc" name="location"
                                                   value=""></td>
                            <td>医疗机构名称:</td>
                            <td colspan="2"><input type="text" class="form-control" id="input-hos" name="hospital"
                                                   value=""></td>
                        </tr>
                        <tr>
                            <td>就医日期:</td>
                            <td colspan="2"><input type="text" class="form-control input-sm picker" id="input-htime"
                                                   name="htime" value="" readonly></td>
                            <td>医嘱内容:</td>
                            <td colspan="2"><input type="text" class="form-control" id="input-yz" name="yz" value="">
                            </td>
                        </tr>
                        <tr>
                            <td>医师姓名:</td>
                            <td colspan="2"><input type="text" class="form-control" id="input-ysname" name="ysname"
                                                   value=""></td>
                            <td>驻店药师签名:</td>
                            <td colspan="2"><input type="text" class="form-control" id="input-zdys" name="zdys"
                                                   value=""></td>
                        </tr>
...
<div class="modal fade" id="myModal2" tabindex="-1" role="dialog">
    <div class="modal-dialog modal-sm" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form action="<%=basePath%>delrxinfo" method="post">
