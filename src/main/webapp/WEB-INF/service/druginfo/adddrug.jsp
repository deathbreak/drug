		...
		<div class="row col-md-4 col-md-offset-4">
			<form action="<%=basePath%>adddrugval" method="post">						
						<div class="form-group">
							...
							<input type="text" class="form-control input-sm" id="inputdn" name="drugname" value="${olddrug.drugname }">
						</div>
						<div class="form-group">
							<label for="inputcs" class="control-label">厂商:</label><span class="forclean" style="color:red" id="span_cs"></span>
							<input type="text" class="form-control input-sm" id="inputcs" name="changshang" value="${olddrug.changshang }">
						</div>
						<div class="form-group">
						...
						<div class="form-group">
							...
							<input type="text" class="form-control input-sm" id="inputloc" name="location" value="${olddrug.location }">
						</div>
						<div class="form-group">
						...
						<div class="form-group">
							...
							<input type="text" class="form-control input-sm" id="inputti" name="tiaoxingma" value="${olddrug.tiaoxingma }">
						</div>
