				...
				<div class="col-md-6">
					...
					<ul class="pagination">
						...
						<c:forEach items="${queryresult.navigatepageNums }" var="page_Num">
							...
							<c:if test="${page_Num != queryresult.pageNum}">
								<li><a href="<%=basePath%>querydrug?pn=${page_Num }&querydrug=${querystring }">${page_Num }</a></li>
							</c:if>
						</c:forEach>
						...
						<li><a href="<%=basePath%>querydrug?pn=${queryresult.pages}&querydrug=${querystring }">末页</a></li>
						<!--  -->
						<li>
							<div class="btn-group dropup">
								...
								<ul class="dropdown-menu">
									<c:forEach var="x" begin="1" end="${queryresult.pages}"
										step="10">
										<li><a
											href="<%=basePath%>querydrug?pn=${x}&querydrug=${querystring }">跳转至第${x }页</a></li>
									</c:forEach>
								</ul>
							</div>
						</li>
