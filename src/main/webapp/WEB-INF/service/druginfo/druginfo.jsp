   ...
   <div class="container-fluid">
		...
		<div class="row" style="padding-top:3px">
			<ul class="nav nav-tabs nav-justified">
				...
				<li role="presentation"  class="active"><a href="<%=basePath%>druginfo">查看药品信息</a></li>
		...
		<c:if test="${queryresult.list.size()==0}">
			<div class="row">
				<div class="page-header">
					<h3 class="text-center">没有查询到符合条件的药品信息！<a href="<%=basePath%>druginfo">返回</a></h3>
				</div>
			</div>
		</c:if>
		<c:if test="${queryresult.list.size()>0}">
			...
			<div class="row">
				...
				<div class="col-md-6">
					...
					<ul class="pagination">
						<li><a href="<%=basePath%>querydrug2?pn=1&querydrug=${querystring }">首页</a></li>
						<c:if test="${queryresult.hasPreviousPage }">
							<li><a href="<%=basePath%>querydrug2?pn=${queryresult.pageNum - 1}&querydrug=${querystring }"
						...
						<c:forEach items="${queryresult.navigatepageNums }" var="page_Num">
							...
							<c:if test="${page_Num != queryresult.pageNum}">
								<li><a href="<%=basePath%>querydrug2?pn=${page_Num }&querydrug=${querystring }">${page_Num }</a></li>
							</c:if>
						</c:forEach>
						...
						<li><a href="<%=basePath%>querydrug2?pn=${queryresult.pages}&querydrug=${querystring }">末页</a></li>
						<!--  -->
						<li>
							<div class="btn-group dropup">
								...
								<ul class="dropdown-menu">
									<c:forEach var="x" begin="1" end="${queryresult.pages}"
										step="10">
										<li><a
											href="<%=basePath%>querydrug2?pn=${x}&querydrug=${querystring }">跳转至第${x }页</a></li>
									</c:forEach>
								</ul>
							</div>
						</li>
		...
		<div class="modal-dialog" role="document">
			<div class="modal-content">
				...
				<div class="modal-body">
					<form action="<%=basePath%>updatedrug2" method="post">
						...
						<div class="form-group">
							<label for="inputdn" class="control-label">药品名称:</label><span class="forclean" style="color:red" id="span_dn"></span>
							<input type="text" class="form-control" id="inputdn" name="drugname" value="">
						</div>
						<div class="form-group">
							<label for="inputcs" class="control-label">厂商:</label><span class="forclean" style="color:red" id="span_cs"></span>
							<input type="text" class="form-control" id="inputcs" name="changshang" value="">
						</div>
						<div class="form-group">
							<label for="inputbz" class="control-label">备注:</label><span class="forclean" style="color:red" id="span_bz"></span>
							<input type="text" class="form-control" id="inputbz" name="beizhu" value="">
						</div>
						<div class="form-group">
							<label for="inputloc" class="control-label">药品位置:</label><span class="forclean" style="color:red" id="span_loc"></span>
							<input type="text" class="form-control" id="inputloc" name="location" value="">
						</div>
						<div class="form-group">
							<label for="inputdw" class="control-label">单位:</label><span class="forclean" style="color:red" id="span_dw"></span>
							<input type="text" class="form-control" id="inputdw" name="unit" value="">
						</div>
						<div class="form-group">
							<label for="inputgg" class="control-label">规格:</label><span class="forclean" style="color:red" id="span_gg"></span>
							<input type="text" class="form-control" id="inputgg" name="guige" value="">
						</div>
						<div class="form-group">
							<label for="inputti" class="control-label">条形码:</label><span class="forclean" style="color:red" id="span_ti"></span>	
	...
	<div class="modal fade" id="myModal2" tabindex="-1" role="dialog">
		<div class="modal-dialog modal-sm" role="document">
			<div class="modal-content">
				...
				<div class="modal-body">
					<form action="<%=basePath%>deletedrug2" method="post">
