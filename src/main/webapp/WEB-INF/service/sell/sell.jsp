...
<div class="container-fluid">
    ...
    <div class="row">
        ...
        <div>
            <a class="btn btn-info btn-lg" href="<%=basePath%>sellit" onclick="event.preventDefault(); check()"
               role="button">结算</a>
    ...
    <div class="modal-dialog modal-lg" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <form action="<%=basePath%>addrxperson" method="post">
                    ...
                    <table class="table table-hover table-condensed table-bordered">
                        ...
                        <tr>
                            ...
                            <td>医嘱内容:</td>
                            <td colspan="2"><input type="text" class="form-control" id="input-yz" name="yz"
                                                   placeholder="" value=""></td>
                        </tr>
                        <tr>
                            <td>医师姓名:</td>
...
<script type="text/javascript">
    ...
    function check() {
        return new Promise((resolve, reject) => {
            ...
            window.location.href = "<%=basePath%>sellit";
        }).catch(() => {
            // Do nothing
        });
    }
