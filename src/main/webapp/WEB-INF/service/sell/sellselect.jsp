...
<html>
  ...
  <c:if test="${empty sessionScope.login }">
   ...
   <div class="container-fluid">
		...
		<c:if test="${forSS.size()==0}">
			<div class="row">
				<div class="page-header">
					<h3 class="text-center">没有查询到符合条件的药品信息！<a href="<%=basePath%>sell">返回</a></h3>
	...
	<form id="ff" action="<%=basePath%>toaddsellamount" method="POST">
